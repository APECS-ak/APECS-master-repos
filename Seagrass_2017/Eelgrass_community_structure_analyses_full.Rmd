...
p.epi <- ggplot(coef.mod2) +
  ...
  scale_y_continuous(limits = c(-1, 1), breaks = seq(-1, 1, by = 0.50)) +
  labs(x = "Term", y = "Estimate +/- 95% CI") +
  scale_x_discrete(labels = c("Benthic\ndiatoms", "Grazers", "Macroalgae", "Sea otter\nindex", "Sediment")) +
  theme(text = element_text(size = 10))
```
...
p.crb <- ggplot(coef.mod4) +
  ...
  scale_y_continuous(limits = c(-1, 1), breaks = seq(-1, 1, by = 0.50)) +
  labs(x = "Term", y = "Estimate +/- 95% CI") +
  scale_x_discrete(labels = c("Fish", "Sea otter\nindex")) +
  theme(text = element_text(size = 10))
```
...
p.fsh <- ggplot(coef.mod5) +
  ...
  scale_y_continuous(limits = c(-1, 1), breaks = seq(-1, 1, by = 0.50)) +
  labs(x = "Term", y = "Estimate +/- 95% CI") +
  scale_x_discrete(labels = c("Eelgrass", "Crabs")) +
  theme(text = element_text(size = 10))
```
...
All together now.
```{r summary plot}
plot_grid(p.fsh, p.crb, p.grz, p.epi, p.abv, ncol = 1, labels = "auto", align = "v", label_x = 0.17)
```
