...
eg.soi <- ggplot(data = dat) +
  ...
  labs(x = "Sea otter index", y = bquote('Seagrass mass*' ~(g/m^2))) +
  scale_x_continuous(limits = c(-0.80, 1.20), breaks = seq(-0.80, 1.20, by = 0.40)) +
...
eg.nox <- ggplot(data = dat) +
  ...
  labs(x = bquote("Nitrate ("*mu~'mol)'), y = bquote('Seagrass mass*' ~(g/m^2))) +
  scale_x_continuous(limits = c(0.0, 3), breaks = seq(0, 3, by = 1)) +
  scale_y_continuous(limits = c(-51, 50), breaks = seq(-50, 50, by = 25)) +
  theme(text = element_text(size = 10))
...
eg.epi <- ggplot(data = dat) +
  ...
  labs(x = "Epiphyte load* (g/g)", y = bquote('Seagrass mass*' ~(g/m^2))) +
  scale_x_continuous(limits = c(-0.08, 0.09), breaks = seq(-0.08, 0.08, by = 0.04)) +
  scale_y_continuous(limits = c(-51, 50), breaks = seq(-50, 50, by = 25)) +
  theme(text = element_text(size = 10)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Cowplot
```{r}
plot_grid(crb.soi, eg.epi, grz.epi, epi.nox, eg.soi, eg.nox, nrow = 3, ncol = 2, align = "v", scale = 0.9)
```
...
epi.fsh <- ggplot(data = dat) +
  ...
  scale_x_continuous(limits = c(0.0, 150000), breaks = seq(0, 150000, by = 50000)) +
  scale_y_continuous(limits = c(-0.07, 0.09), breaks = seq(-0.06, 0.09, by = 0.03)) +
  theme(text = element_text(size = 10)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
eg.dia <- ggplot(data = dat) +
  ...
  labs(x = "Diatom cover", y = bquote('Seagrass mass*' ~(g/m^2))) +
  scale_x_continuous(limits = c(0, 1.8), breaks = seq(0, 1.8, by = 0.4)) +
  scale_y_continuous(limits = c(-51, 50), breaks = seq(-50, 50, by = 25)) +
  theme(text = element_text(size = 10)) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
eg.sed <- ggplot(data = dat) +
  ...
  labs(x = "Sediment score", y = bquote('Seagrass mass*' ~(g/m^2))) +
  scale_x_continuous(limits = c(0, 5.2), breaks = seq(0, 5, by = 1)) +
  scale_y_continuous(limits = c(-51, 50), breaks = seq(-50, 50, by = 25)) +
  theme(text = element_text(size = 10))
```
