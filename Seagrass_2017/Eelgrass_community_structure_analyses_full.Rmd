...
pits.site <- pits %>%
    ...
    summarise(pit_mean= mean(pit_bin),
              pit_st.er = st.er(pit_bin))

dat$pits <- pits.site$pit_mean
```
...
dat.cor <- dat[, c(4, 15, 94, 99, 81, 126, 125, 123, 90, 92, 124)]
colnames(dat.cor) <- c("Julianday", "SO_dens", "Crabs", "Fish", "Epifauna", "Epiphytes", "Seagrass", "Nitrate", "Sediment", "Light", "Pits")

## Transform as necessary ##
dat.cor <- as.data.frame(cbind(dat.cor$Julianday, 
                               log(dat.cor$SO_dens + 1), 
                               sqrt(dat.cor$Crabs),
                               log(dat.cor$Fish),
                               log(dat.cor$Epifauna), 
                               dat.cor$Epiphytes, 
                               dat.cor$Seagrass, 
                               dat.cor$Nitrate, 
                               dat.cor$Sediment,
...
colnames(dat.cor) <- c("Julian Day", "SO_dens", "Crabs", "Fish", "Epifauna", "Epiphytes*", "Seagrass*", "Nitrate", "Sediment", "Light", "Pits")
...
mod1 <- lm(abvgnd_mass_dt ~ dens_surv_avg + dens_surv_avg_sq + crab_mass + grazermass_shootmass + epiphmass_shootmass_dt + NOx_site, data = dat)
```
