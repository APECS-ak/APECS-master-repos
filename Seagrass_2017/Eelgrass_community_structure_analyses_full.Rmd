...
colnames(dat.cor) <- c("Julianday", "SOI", "Crabs", "Epifauna", "Epiphytes*", "Eelgrass*", "Nitrate", "Fish", "Macroalgae", "Diatoms", "Sediment")
...
colnames(dat.cor) <- c("Julian day", "SOI", "Crabs", "Epifauna", "Epiphytes*", "Eelgrass*", "Nitrate", "Fish", "Macroalgae", "Diatoms", "Sediment")
