...
dat.cor <- dat[, c(4, 19, 94, 81, 125, 124, 123, 99, 35, 37, 90)]
colnames(dat.cor) <- c("Julianday", "SOI", "Crabs", "Epifauna", "Epiphytes", "Seagrass", "Nitrate", "Fish", "Macroalgae", "Diatoms", "Sediment")
...
dat.cor <- as.data.frame(cbind(dat.cor$Julianday, 
                               ...
                               dat.cor$Nitrate, 
                               log(dat.cor$Fish), 
                               asin(sqrt(dat.cor$Macroalgae / 100)), 
                               asin(sqrt(dat.cor$Diatoms / 100)), 
                               dat.cor$Sediment))

colnames(dat.cor) <- c("Julian day", "SOI", "Crabs", "Epifauna", "Epiphytes*", "Seagrass*", "Nitrate", "Fish", "Macroalgae", "Diatoms", "Sediment")
