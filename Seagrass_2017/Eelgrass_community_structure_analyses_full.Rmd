...
dat.cor <- dat[, c(4, 88, 92, 77, 69, 117, 19, 35, 37, 84, 116)]
colnames(dat.cor) <- c("Julianday", "Crabs", "Fish", "Grazers", "Epiphytes", "Eelgrass", "SOI", "Macroalgae", "Diatoms", "Sediment", "Nitrate")

## Transform as necessary ##
dat.cor <- as.data.frame(cbind(dat.cor$Julianday, dat.cor$SOI, sqrt(dat.cor$Crabs), log(dat.cor$Grazers), dat.cor$Epiphytes, dat.cor$Eelgrass, dat.cor$Nitrate, log(dat.cor$Fish), asin(sqrt(dat.cor$Macroalgae / 100)), asin(sqrt(dat.cor$Diatoms / 100)), dat.cor$Sediment))
colnames(dat.cor) <- c("Julian day", "SOI", "Crabs", "Grazers", "Epiphytes", "Eelgrass", "Nitrate", "Fish", "Macroalgae", "Diatoms", "Sediment")

correl <- cor(dat.cor)

## Plotting correlations ##
corrplot(correl, method = "color", type = "lower", addCoef.col =  "black", number.cex = 0.5, tl.cex = 0.6, cl.cex = 0.5, tl.col = "black")
...
Testing for efffects of sites on environmental variables.
...
## Crabs and SOI ##
ggplot(data = dat) +
  geom_point(aes(x = sea_otter_index_tr, y = crab_mass), size = 1.5) +
  geom_errorbar(aes(x = sea_otter_index_tr, ymin = round(crab_mass - crab_mass_se, 2), ymax = crab_mass + crab_mass_se), width = 0) +
  labs(x = "Sea otter index", y = "Crab mass (g)") +
...
## Grazers and Crabs ##
ggplot(data = dat) +
  geom_point(aes(x = crab_mass, y = grazermass_shootmass), size = 1.5) +
  geom_errorbar(aes(x = crab_mass, ymin = grazermass_shootmass - grazermass_shootmass_se, ymax = grazermass_shootmass + grazermass_shootmass_se), width = 0) +
  labs(x = "Crab mass (g)", y = "Grazer load (g/g)") +
  scale_x_continuous(limits = c(0, 300), breaks = seq(0, 300, by = 50)) +
  scale_y_continuous(limits = c(-0.0, 0.24), breaks = seq(0, 0.24, by = 0.04)) +
  theme(text = element_text(size = 10))

## Grazers and Epiphytes ##
ggplot(data = dat) +
  geom_point(aes(x = epiphmass_shootmass, y = grazermass_shootmass), size = 1.5) +
  geom_errorbar(aes(x = epiphmass_shootmass, ymin = grazermass_shootmass - grazermass_shootmass_se, ymax = grazermass_shootmass + grazermass_shootmass_se), width = 0) +
  labs(x = "Epiphyte load (g/g)", y = "Grazer load (g/g)") +
  scale_x_continuous(limits = c(-0.0, 0.20), breaks = seq(0, 0.20, by = 0.04)) +
  scale_y_continuous(limits = c(-0.0, 0.24), breaks = seq(0, 0.24, by = 0.04)) +
  theme(text = element_text(size = 10))

## Epi and Nitrate ##
ggplot(data = dat) +
  geom_point(aes(x = NOx_site, y = epiphmass_shootmass), size = 1.5) +
  geom_errorbar(aes(x = NOx_site, ymin = epiphmass_shootmass - epiphmass_shootmass_se, ymax = epiphmass_shootmass + epiphmass_shootmass_se), width = 0) +
...
## Eelgrass and SOI ##
ggplot(data = dat) +
  geom_point(aes(x = sea_otter_index_tr, y = abvgnd_mass), size = 1.5) +
  geom_errorbar(aes(x = sea_otter_index_tr, ymin = abvgnd_mass - abvgnd_mass_se, ymax = abvgnd_mass + abvgnd_mass_se), width = 0) +
  labs(x = "Sea otter index", y = bquote('Eelgrass mass' ~(g/m^2))) +
  scale_x_continuous(limits = c(-0.80, 1.20), breaks = seq(-0.80, 1.20, by = 0.40)) +
  scale_y_continuous(limits = c(0.0, 200), breaks = seq(0, 200, by = 50)) +
  theme(text = element_text(size = 10))

## Eelgrass and Nitrate ##
ggplot(data = dat) +
  geom_point(aes(x = NOx_site, y = abvgnd_mass), size = 1.5) +
  geom_errorbar(aes(x = NOx_site, ymin = abvgnd_mass - abvgnd_mass_se, ymax = abvgnd_mass + abvgnd_mass_se), width = 0) +
  labs(x = bquote("Nitrate ("*mu~'mol)'), y = bquote('Eelgrass mass' ~(g/m^2))) +
  scale_x_continuous(limits = c(0.0, 3), breaks = seq(0, 3, by = 1)) +
  scale_y_continuous(limits = c(0.0, 200), breaks = seq(0, 200, by = 50)) +
  theme(text = element_text(size = 10))
...
ggplot(data = dat) +
  geom_point(aes(x = epiphmass_shootmass, y = abvgnd_mass), size = 1.5) +
  geom_errorbar(aes(x = epiphmass_shootmass, ymin = abvgnd_mass - abvgnd_mass_se, ymax = abvgnd_mass + abvgnd_mass_se), width = 0) +
  labs(x = "Epiphyte load (g/g)", y = bquote('Eelgrass mass' ~(g/m^2))) +
  scale_x_continuous(limits = c(0.0, 0.20), breaks = seq(0, 0.20, by = 0.04)) +
  scale_y_continuous(limits = c(0.0, 200), breaks = seq(0, 200, by = 50)) +
  theme(text = element_text(size = 10))
```
