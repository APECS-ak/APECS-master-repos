...
```{r data import}
# Eelgrass Site
eg.site <- read.csv("ALL_DATA/seagrass_site_RAW.csv", stringsAsFactors = FALSE, header = TRUE)
...
so.index <- read.csv("E:/wraymond2/My Documents/Graduate School/Eelgrass/Data/2017 Field Season/Sea Otter Impact Index/Sea_Otter_Impact_Index_2017_WR.csv", stringsAsFactors = FALSE, header = TRUE)
