...
![](../Images/Raymond_SEM_Full_v3.png)
...
6. Macroalgae (as percent cover - asin(sqrt()) transformed)
7. Benthic diatoms (as percent cover - asin(sqrt()) transformed and de-trended with respect to julian day)
...
dat.redu$macro_as <- asin(sqrt(dat$macro_dens / 100))
dat.redu$diatom_dt <- dat$diatom_dens_dt
