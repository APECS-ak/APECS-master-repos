...
```{r}
sem.mod <- psem(
    lm(sqrt(abvgnd_mass + blwgnd_mass) ~  date_julian + sea_otter_index_tr + log(epiphmass_shootmass) + sed_inside_prim + light_avail + Ntotal_site, data = dat),
    
    lm(log(epiphmass_shootmass) ~  date_julian + sea_otter_index_tr + log(grazermass_shootmass) + sed_inside_prim + light_avail + Ntotal_site, data = dat),
    
    lm(log(grazermass_shootmass) ~ sea_otter_index_tr  + sqrt(crab_mass) + log(fish_preds) + sed_inside_prim + light_avail + Ntotal_site, data = dat),
    
    lm(sqrt(crab_mass) ~  sea_otter_index_tr + log(dat$grazermass_shootmass) + sqrt(abvgnd_mass + blwgnd_mass) + log(fish_preds), data = dat),
    
    lm(log(fish_preds) ~  sea_otter_index_tr + log(dat$grazermass_shootmass) + sqrt(abvgnd_mass + blwgnd_mass) + sqrt(crab_mass), data = dat)
)
