...
Light availability. Is reasoinably normal. We will proceed with values untransformed.
...
sem.full <- psem(
  ...
  lm(fish_mass_ln ~ sea_otter_index_tr + abvgnd_mass_dt + sed_inside_prim, data = dat.redu),
...
sem.full <- psem(
  ...
  lm(fish_mass_ln ~ sea_otter_index_tr + crab_mass_sq + abvgnd_mass_dt + sed_inside_prim, data = dat.redu),
