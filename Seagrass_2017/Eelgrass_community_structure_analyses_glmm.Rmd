...
```{r}
pairs(dat[, c(4, 21, 51, 101, 109, 118, 115, 116)])
```
...
## Global Model ##
mod1 <- dredge(glm(dat$abvgnd_mass ~ dat$date_julian + dat$sea_otter_index + log(dat$epiphmass_shootmass) + log(dat$grazermass_shootmass) + sqrt(dat$crab_mass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
pred.1.jday <- predict(mod1.best, backtransform = TRUE, se.fit = TRUE)
...
## Global Model ##
mod2 <- dredge(glm(log(dat$blwgnd_mass) ~ dat$date_julian + dat$sea_otter_index + log(dat$epiphmass_shootmass) + log(dat$grazermass_shootmass) + sqrt(dat$crab_mass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod3 <- dredge(glm.nb(dat$shoot_dens_rnd ~ dat$date_julian  + dat$sea_otter_index  + log(dat$epiphmass_shootmass) + log(dat$grazermass_shootmass) + sqrt(dat$crab_mass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site , link = "log"), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod4 <- dredge(glm((dat$abvgnd_mass / dat$blwgnd_mass) ~ dat$date_julian + dat$sea_otter_index  + log(dat$epiphmass_shootmass) + log(dat$grazermass_shootmass) + sqrt(dat$crab_mass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod6 <- dredge(glm(log(dat$epiphmass_shootmass) ~ dat$date_julian + dat$sea_otter_index + dat$abvgnd_mass + log(dat$grazermass_shootmass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site + sqrt(dat$crab_mass)), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod7 <- dredge(glm(log(dat$grazermass_shootmass) ~ dat$date_julian + dat$sea_otter_index + dat$abvgnd_mass + log(dat$epiphmass_shootmass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site + sqrt(dat$crab_mass)) , rank = "AICc", beta = "partial.sd", evaluate = TRUE)
