...
# Sea Otter Index #
newdata.6.soi <- data.frame(abvgnd_mass = rep(median(dat$abvgnd_mass), 100), sea_otter_index = seq(min(dat$sea_otter_index), max(dat$sea_otter_index), length.out = 100), grazermass_shootmass = rep(median(dat$grazermass_shootmass), 100))
