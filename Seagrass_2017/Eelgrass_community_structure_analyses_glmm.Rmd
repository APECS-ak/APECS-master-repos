...
ggplot(dat) +
  ...
  geom_smooth(aes(x = sea_otter_index, y = abvgnd_mass), method = loess) +
...
## Global Model ##
mod1 <- dredge(lm(abvgnd_mass ~ date_julian + sea_otter_index + log(epiphmass_shootmass) + log(grazermass_shootmass) + sqrt(crab_mass) + log(fish_preds) + sed_inside_prim + light_avail + Ntotal_site, data = dat), evaluate = TRUE, beta = "partial.sd")
...
## Best Model ##
mod1.best <- model.avg(mod1, fit = TRUE, rank = "AICc", subset = delta < 2, beta = "partial.sd")
summary(mod1.best)
...
## Global Model ##
mod2 <- dredge(glm(log(blwgnd_mass) ~ date_julian + sea_otter_index + log(epiphmass_shootmass) + log(grazermass_shootmass) + sqrt(crab_mass) + log(fish_preds) + sed_inside_prim + light_avail + Ntotal_site, data = dat), evaluate = TRUE, beta = "partial.sd")
...
## Time ##
ggplot(dat) +
  geom_point(aes(x = date_julian, y = sqrt(abvgnd_mass + blwgnd_mass), col = sea_otter_index), size = 4) +
  scale_color_gradient(low = "blue", high = "red") +
...
## Sea otter index ##
ggplot(dat) +
  geom_point(aes(x = sea_otter_index, y = sqrt(abvgnd_mass + blwgnd_mass)), size = 4) +
...
```{r model 2, echo = FALSE}
## Global Model ##
mod1t <- dredge(glm(sqrt(abvgnd_mass + blwgnd_mass) ~ date_julian + sea_otter_index + log(epiphmass_shootmass) + log(grazermass_shootmass) + sqrt(crab_mass) + log(fish_preds) + sed_inside_prim + light_avail + Ntotal_site, data = dat), evaluate = TRUE)
...
## Global Model ##
mod3 <- dredge(glm.nb(dat$shoot_dens_rnd ~ dat$date_julian  + dat$sea_otter_index  + log(dat$epiphmass_shootmass) + log(dat$grazermass_shootmass) + sqrt(dat$crab_mass) + log(dat$fish_preds) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site , link = "log"), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod4 <- dredge(glm((dat$abvgnd_mass / dat$blwgnd_mass) ~ dat$date_julian + dat$sea_otter_index  + log(dat$epiphmass_shootmass) + log(dat$grazermass_shootmass) + sqrt(dat$crab_mass) + log(dat$fish_preds) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod6 <- dredge(glm(log(dat$epiphmass_shootmass) ~ dat$date_julian + dat$sea_otter_index + dat$abvgnd_mass + log(dat$grazermass_shootmass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site + sqrt(dat$crab_mass) + log(dat$fish_preds)), rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod7 <- dredge(glm(log(dat$grazermass_shootmass) ~ dat$date_julian + dat$sea_otter_index + dat$abvgnd_mass + log(dat$epiphmass_shootmass) + dat$sed_inside_prim + dat$light_avail + dat$Ntotal_site + sqrt(dat$crab_mass) + log(dat$fish_preds)) , rank = "AICc", beta = "partial.sd", evaluate = TRUE)
...
## Global Model ##
mod8 <- dredge(glm(sqrt(dat$crab_mass) ~ dat$date_julian + dat$sea_otter_index + log(dat$grazermass_shootmass) + dat$abvgnd_mass + log(dat$epiphmass_shootmass) + log(dat$fish_preds)), rank  ="AICc", evaluate = TRUE)
...
## Global Model ##
mod9 <- dredge(glm(log(dat$fish_preds) ~ dat$date_julian + dat$sea_otter_index + log(dat$grazermass_shootmass) + dat$abvgnd_mass + log(dat$epiphmass_shootmass) + sqrt(dat$crab_mass)), rank  ="AICc", evaluate = TRUE)

# AICc comp #
mod9$delAICprop <- mod9$delta / mod8$AICc
