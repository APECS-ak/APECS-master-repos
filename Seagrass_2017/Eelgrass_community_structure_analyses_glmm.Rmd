...
### Top Models 2
Table of top three models their AIC values and resid df
```{r}
## Fit other top models ##
mod2.1 <- summary(mod2.best)
mod2.2 <- summary(glm(log(blwgnd_mass) ~  date_julian, data = dat))
