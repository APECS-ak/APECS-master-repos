...
Crab <- ## INSERT CRAB SAMPLES HERE ##
Fish <- ## INSERT FISH SAMPLES HERE ##
Sitetxt <- tran.dat$site[ii]
Quad <- as.numeric(tran.dat$quadrat)[ii]
...
# Model comparison data frame
ModComp.5 <- data.frame(Model = c("Model_6a","Model_6b","Model_6c","Model_6d","Model_6e","Model_6f","Model_6g", "Model_6h", "Model6i"), WAIC = numeric(length = 12), LOOIC = numeric(length = 12))
