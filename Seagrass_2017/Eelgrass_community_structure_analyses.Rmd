...
# Model comparison data frame
ModComp.3 <- data.frame(Model = c("Model_3a","Model_3b","Model_3c","Model_3d","Model_3e","Model_3f","Model_3g", "Model_3h"), WAIC = numeric(length = 8), LOOIC = numeric(length = 8))
...
inits <- function() list(sigS = runif(1, .1, 1), sig0 = runif(1, .1, 1)) 
...
WAIC <- waic(mc_ll)
WAIC3d <- WAIC
ModComp.3$WAIC[4] <- WAIC3c$waic

# Calculate LOOIC
LOOIC <- loo(mc_ll)
LOOIC3d <- LOOIC
ModComp.3$LOOIC[4] <- LOOIC3b[3]
