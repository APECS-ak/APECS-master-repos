...
Julianday <- as.numeric(tran.dat$date_julian)[ii]
Light <- as.numeric(tran.dat$light_attenu)[ii]
Graz <- as.numeric(log(tran.dat$grazmass_shootmass)) [ii]
Sitetxt <- tran.dat$site[ii]
Quad <- as.numeric(tran.dat$quadrat)[ii]
...
# Model comparison data frame
ModComp.5 <- data.frame(Model = c("Model_5a","Model_5b","Model_5c","Model_5d","Model_5e","Model_5f","Model_5g", "Model_5h"), WAIC = numeric(length = 8), LOOIC = numeric(length = 8))
