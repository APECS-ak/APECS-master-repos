...
site.quad$epimass_shootarea <- ((site.quad$epi_mass + site.quad$exepi_mass) / site.quad$shoot_area)

## Epiphytes per eelgrass mass ##
site.quad$epimass_shootmass <- ((site.quad$epi_mass + site.quad$exepi_mass) / site.quad$shoot_mass)
