...
#fishLW <- read.csv("../ALL_DATA/INSERT HERE")
```
...
```{r}
hist(fish.m$fork_length[fish.m$sp_code == "SANDLNCP"], breaks = 10)

summary(fish.m$fork_length[fish.m$sp_code == "SANDLNCP"])

hist(rnorm(2000, mean(fish.m$fork_length[fish.m$sp_code == "SANDLNCP"], sd(fish.m$fork_length[fish.m$sp_code == "SANDLNCP"]))))
```
