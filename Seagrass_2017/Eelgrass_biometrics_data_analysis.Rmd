...
Append assigned lengths to master data
```{r}
fish.all <- bind_rows(fish.m, d)
```


Option 2 will generate a smooth distribution around the sampled fish and then create a function to assing lengths - this is NOT preferes as on Feb 7 2018
