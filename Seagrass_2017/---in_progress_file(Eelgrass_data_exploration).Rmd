...
```{r crabs sea otters}
## Crab Mass ##
CRBM.SOII <- ggplot(eg.dat, aes(PCA2, crab_mass)) +
  geom_point(size = 4) +
...
## Crab size ##
CRBS.SOII <- ggplot(eg.dat, aes(PCA2, crab_width)) +
  geom_point(size = 4) +
...
## Total crabs ##
CRBT.SOII <- ggplot(eg.dat, aes(PCA2, total_crab)) +
  geom_point(size = 4) +
...
CRBSW.SOII <- ggplot(eg.dat, aes(PCA2, shan_diverse)) +
  geom_point(size = 4) +
  labs(x = "Sea otter index", y = "S-W diversity") +
  theme(text = element_text(size = 12), axis.ticks = element_line(size = 2))

## Crab Diversity - simpson ##
CRBSP.SOII <- ggplot(eg.dat, aes(PCA2, simp_diverse)) +
  geom_point(size = 4) +
