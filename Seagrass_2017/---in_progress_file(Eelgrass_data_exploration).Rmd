...
## Crab Diversity - shannon weiner ##
CRBSW.JDAY <- ggplot(eg.dat, aes(date_pulled_julian, shan_diverse, col = sea_otter_index)) +
  geom_point(size = 4) +
  scale_color_gradient(low = "blue", high = "red") +
...
## Crab Diversity - simpson ##
CRBSP.JDAY <- ggplot(eg.dat, aes(date_pulled_julian, simp_diverse, col = sea_otter_index)) +
  geom_point(size = 4) +
  scale_color_gradient(low = "blue", high = "red") +
...
FSHSW.SOII <- ggplot(eg.dat, aes(sea_otter_index, shan_diverse)) +
  geom_point(size = 4) +
  labs(x = "Sea otter index", y = "S-W diversity") +
  theme(text = element_text(size = 12), axis.ticks = element_line(size = 2))

## Fish Diversity - simpson ##
FSHSP.SOII <- ggplot(eg.dat, aes(sea_otter_index, simp_diverse)) +
  geom_point(size = 4) +
  labs(x = "Sea otter index", y = "Simpson diversity") +
  theme(text = element_text(size = 12), axis.ticks = element_line(size = 2))
```
...
For these expoloratory analyses we will need to merge all the data.
```{r merga all data}
# add fish
eg.dat <- merge(eg.dat, fish.dat, by = "site")
