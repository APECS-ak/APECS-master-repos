...
OK. From the previous reshaping, we have 6 DFs (df.coords, df.trans2, df.sedpit2, df.sedpit_trans, df.bio2, df.mass_area) that we want to join into one big DF. This results in 50 columns of unique names (after Julian day conversion)...that's a lot but we aren't concerned about ALL of them...they are just there for exploration, afterall. 
...
```{r, include = FALSE}
df.all <- df.all[c(1,2,3,4,5,50,6,15,16,17,11,19,18,20,22,21,23,25,24,26,12,13,14,7,8,27,10,28,9,49,32,31,34,33,29,30,35,36,37,48,43,44,45,46,47,38,39,40,41,42)]
```
<br>
