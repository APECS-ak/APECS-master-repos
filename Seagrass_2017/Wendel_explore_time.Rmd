...
Various models. Again, the mixed effects approach here is likley not appropriate. However, I included it here just to see. So what is intersting here is that sea otter index becomes significant when time is included as a factor (mod2.2), demonstrating that time is mopping up variability. 
```{r, echo = FALSE}
...
colnames(op3comp) <- c("Model", "Rsq", "Dev_Expln")
