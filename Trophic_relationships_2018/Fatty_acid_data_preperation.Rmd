...
## Batch 1 ##
b1_ac <- gather(b1_area, key = "FA", value = "Area", 2:59)
b1_ac$Conc <- gather(b1_conc, key = "FA", value = "Conc", 2:59)[,3]
b1_ac$Batch <- as.character(1)

## Batch 2 ##
b2_ac <- gather(b2_area, key = "FA", value = "Area", 2:60)
b2_ac$Conc <- gather(b2_conc, key = "FA", value = "Conc", 2:60)[,3]
b2_ac$Batch <- as.character(2)

## Batch 3 ##
b3_ac <- gather(b3_area, key = "FA", value = "Area", 2:53)
b3_ac$Conc <- gather(b3_conc, key = "FA", value = "Conc", 2:53)[,3]
...
<<<<<<< HEAD
  gather(key = "FA", value = "Prop", 4:69) %>% 
=======
  gather(key = "FA", value = "Prop", 4:68) %>% 
>>>>>>> 98dbdf30636ac3ad9c14528f3f1cc88e9a7f3f7d
  group_by(Species_common, FA) %>% 
  summarise(n = n(),
