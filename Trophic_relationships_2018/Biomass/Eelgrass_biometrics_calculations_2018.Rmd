...
site.tran <- eg.tran %>% 
  ...
  summarise(macro_cover = mean(macroalgae_cover_0.25msq, na.rm = TRUE),
            ...
            eelgrass_shoot_dens_se = st.er(eelgrass_shoot_dens, na.rm = TRUE),
            flowering_shoot_dens = mean(flowering_shoots_msq, na.rm = TRUE),
            flowering_shoot_dens_se = st.er(flowering_shoots_msq, na.rm = TRUE),
            sed_prime = mean(primary_sediment),
            sed_prime_se = st.er(primary_sediment),
            sed_second  = mean(secondary_sediment),
            sed_second_se = st.er(secondary_sediment))
```
