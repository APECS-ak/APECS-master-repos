...
fa_crb_1.0_trs <- asin(sqrt(fa_crb_1.0[, 3:67]))
...
ggplot(fa_crb_1.0_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, shape = Sea_otter_region, color = Species_common), size = 3.5) +
  scale_color_manual(values = c("chocolate4", "darkgreen", "red")) +
  scale_shape_manual(values = c(16, 1))
