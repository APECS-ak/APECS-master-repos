...
fa_con_1.0 <- cbind(fa_con_1.0[,c(70:77, 1:2, 4:68)])
...
fa_crb_1.0 <- cbind(fa_crb_1.0[,c(70:77, 1:2, 4:68)])
...
fa_dun_1.0 <- cbind(fa_dun_1.0[,c(70:77, 1:2, 4:68)])
...
fa_hel_1.0 <- cbind(fa_hel_1.0[,c(70:77, 1:2, 4:68)])
...
## Secondary consumers ##
fa_con_1.0_trs <- asin(sqrt(fa_con_1.0[, 11:75]))
fa_crb_1.0_trs <- asin(sqrt(fa_crb_1.0[, 11:75]))
fa_dun_1.0_trs <- asin(sqrt(fa_dun_1.0[, 11:75]))
fa_hel_1.0_trs <- asin(sqrt(fa_hel_1.0[, 11:75]))
...
## Dungeness crabs ##
fa_dun_1.0_dist <- vegdist(fa_dun_1.0_trs, method = "euclidean")

## Helmet crabs ##
fa_hel_1.0_dist <- vegdist(fa_hel_1.0_trs, method = "euclidean")

## Primary consumers ##
fa_pcon_1.0_dist <- vegdist(fa_pcon_1.0_trs, method = "euclidean")

## Idotea ##
fa_ido_1.0_dist <- vegdist(fa_ido_1.0_trs, method = "euclidean")
```
...
perm.crb.2 <- adonis2(fa_crb_1.0_dist ~ Sea_otter_tr + sp_code %in% Sea_otter_tr, data = fa_crb_1.0, perm = 9999) 
perm.crb.2
...
## Idotea ##
perm.ido <- adonis2(fa_ido_1.0_dist ~ Sea_otter_tr, data = fa_ido_1.0, perm = 9999)
perm.ido
```
...
## Idotea ##
fa_ido_1.0_mds <- metaMDS(fa_ido_1.0_dist)
```
