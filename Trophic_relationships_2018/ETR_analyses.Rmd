...
fa_pro_1.0 <- cbind(fa_pro_1.0[,c(71:75, 1, 3:69)])
colnames(fa_pro_1.0)[7] <- "Species_common"
...
colnames(fa_con_1.0)[7] <- "Species_common"
...
## Transformation ##
fa_pro_1.0_trs <- asin(sqrt(fa_pro_1.0[, 8:73]))
fa_con_1.0_trs <- asin(sqrt(fa_con_1.0[, 8:73]))
