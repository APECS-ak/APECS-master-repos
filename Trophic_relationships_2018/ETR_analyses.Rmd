...
## All fish ##
hist(fsh$total_fish_mass, breaks = 10)
...
si.low.all <- ggplot() +
  ...
  scale_color_manual(values = so.pal[2], "Sea otter treatment") +
  scale_shape_manual(values = shape.pal, "Trophic role", labels = c("Primary consumer", "Primary producer", "Secondary consumer")) +
...
si.high.n <- ggplot(si.sum.h) +
  ...
  scale_color_manual(values = so.pal[1], "Sea otter treatment") +
  scale_shape_manual(values = shape.pal, "Trophic role", labels = c("Primary consumer", "Primary producer", "Secondary consumer")) +
...
si.pan1 <- cowplot::plot_grid(si.high.all, si.low.all, si.high.n, si.low.n, labels = c("a", "b", "c", "d"), nrow = 2, ncol = 2, label_size = 10)
