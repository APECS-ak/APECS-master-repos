...
## Clean up ##
fa_grp_MWU <- rbind(ALA.LIN.MWU, C18PUFA.MWU, PUFA.MWU, BAC.MWU, PAL.MWU, ALA.MWU, LIN.MWU, ARA.MWU, EPA.MWU, DHA.MWU)
...
## Clean up ##
fa_grp_MWU_c <- rbind(ALA.LIN.MWU_c, C18PUFA.MWU_c, PUFA.MWU_c, BAC.MWU_c, PAL.MWU_c, ALA.MWU_c, LIN.MWU_c, ARA.MWU_c, EPA.MWU_c, DHA.MWU_c)
...
hist(fa_c_tll_epa$conc)
hist(sqrt(fa_c_tll_epa$conc))

epa.mod.1 <- lm(sqrt(conc) ~ Sea_otter_region * Species_common, data = fa_c_tll_epa)

anova(epa.mod.1)

epa.mod.2 <- lm(conc ~ Sea_otter_region, data = fa_c_tll_epa) 
...
hist(fa_c_tll_dha$conc)
hist(sqrt(fa_c_tll_dha$conc))

dha.mod.1 <- lm(sqrt(conc) ~ Sea_otter_region * Species_common, data = fa_c_tll_dha)

anova(dha.mod.1)

dha.mod.2 <- lm(conc ~ Sea_otter_region,  data = fa_c_tll_dha)
