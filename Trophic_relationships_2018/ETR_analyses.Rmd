...
fa_tll <- fa_mrk  %>% 
  gather(key = "FA", value = "prop", 11:42) %>% 
  filter(Species_common != "Red rock crab")
...
## EPA:DHA ##
fa_EPA.DHA_all <- fa_tll %>% 
  filter(FA == "EPA.DHA")
colnames(fa_DHA_all)[11] <- "FA_grp"
colnames(fa_DHA_all)[12] <- "prop_sum"

fa_EPA.DHA_all <- cbind(fa_EPA.DHA_all[, c(1:10, 12, 11)])  
...
# Fucus #
vec.fu <- envfit(fa_fu_mds$points, fa_fu[, 11:41], perm = 9999)
...
# Eelgrass #
vec.eg <- envfit(fa_eg_mds$points, fa_eg[, 11:41], perm = 9999)
...
# Ulva #
vec.ul <- envfit(fa_ul_mds$points, fa_ul[, 11:41], perm = 9999)
...
## Primary Consumers ##
# Idotea #
vec.ido <- envfit(fa_ido_mds$points, fa_ido[, 11:41], perm = 9999)
...
# Limpet #
vec.lmp <- envfit(fa_lmp_mds$points, fa_lmp[, 11:41], perm = 9999)
...
# Butter clam #
vec.but <- envfit(fa_but_mds$points, fa_but[, 11:41], perm = 9999)
...
## Secondary Consumers ##
# Dock Shrimp #
vec.dsh <- envfit(fa_dsh_mds$points, fa_dsh[, 11:41], perm = 9999)
...
# Graceful crabs #
vec.grc <- envfit(fa_grc_mds$points, fa_grc[, 11:41], perm = 9999)
...
# Staghorn sculpin #
vec.stg <- envfit(fa_stg_mds$points, fa_stg[, 11:41], perm = 9999)
...
ggplot(fa_fu_mds_dat) +
  ...
  geom_segment(data = vec.fu.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.fu.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha=0.5, size=3, parse = T, angle = fu_arrow_angle, hjust = fu_arrow_hjust) +
  scale_x_continuous(limits = c(-0.05, 0.07)) +
  scale_y_continuous(limits = c(-0.08, 0.05)) +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank())
  
# POM #   
ggplot(fa_pm_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.pm.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.pm.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha = 0.5, size = 3, parse = T, angle = pm_arrow_angle, hjust = pm_arrow_hjust) +
  scale_x_continuous(limits = c(-0.16, 0.14)) +
...
ggplot(fa_eg_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.eg.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.eg.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha=0.5, size=3, parse = T, angle = eg_arrow_angle, hjust = eg_arrow_hjust) +
  scale_x_continuous(limits = c(-0.1, 0.2)) +
  scale_y_continuous(limits = c(-0.055, 0.09)) +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank())
...
ggplot(fa_ul_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.ul.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.ul.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha=0.5, size=3, parse = T, angle = ul_arrow_angle, hjust = ul_arrow_hjust) +
  scale_x_continuous(limits = c(-0.23, 0.3)) +
  scale_y_continuous(limits = c(-0.16, 0.2)) +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank())
...
ggplot(fa_ido_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.ido.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.ido.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha=0.5, size=3, parse = T, angle = ido_arrow_angle, hjust = ido_arrow_hjust) +
  scale_x_continuous(limits = c(-0.22, 0.2)) +
...
ggplot(fa_lmp_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.lmp.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.lmp.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha=0.5, size=3, parse = T, angle = lmp_arrow_angle, hjust = lmp_arrow_hjust) +
  scale_x_continuous(limits = c(-0.16, 0.15)) +
  scale_y_continuous(limits = c(-0.14, 0.1)) +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank())

# Butter Clam #
ggplot(fa_but_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.but.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.but.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha=0.5, size=3, parse = T, angle = but_arrow_angle, hjust = but_arrow_hjust) +
...
ggplot(fa_dsh_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.dsh.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.dsh.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha = 0.5, size = 3, parse = T, angle = dsh_arrow_angle, hjust = dsh_arrow_hjust) +
...
ggplot(fa_grc_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.grc.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.grc.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha = 0.5, size = 3, parse = T, angle = grc_arrow_angle, hjust = grc_arrow_hjust) +
  scale_x_continuous(limits = c(-0.13, 0.15)) +
...
ggplot(fa_stg_mds_dat) +
  geom_point(aes(x = NMDS1, y = NMDS2, color = Sea_otter_region), size = 2) +
  scale_color_manual(values = so.pal, "Sea otter treatment") +
  geom_segment(data = vec.stg.dat.sig, aes(x = 0, y = 0, xend = MDS1_sc, yend = MDS2_sc), arrow = arrow(length = unit(0.15, "inches")), colour = "gray50", alpha = 1) +
  geom_text(data = vec.stg.dat.sig, aes(MDS1_sc * 1.02, MDS2_sc * 1.02, label = FA), alpha = 0.5, size = 3, parse = T, angle = stg_arrow_angle, hjust = stg_arrow_hjust) +
  scale_x_continuous(limits = c(-0.12, 0.14)) +
