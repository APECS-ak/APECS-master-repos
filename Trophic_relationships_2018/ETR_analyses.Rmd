...
## Primary Producers ##
fa_pro_trs <- asin(sqrt(fa_pro[, 11:42]))
fa_eg_trs <- asin(sqrt(fa_eg[, 11:42]))
fa_ep_trs <- asin(sqrt(fa_ep[, 11:42]))
fa_fu_trs <- asin(sqrt(fa_fu[, 11:42]))
fa_pm_trs <- asin(sqrt(fa_pm[, 11:42]))
fa_sk_trs <- asin(sqrt(fa_sk[, 11:42]))
fa_ul_trs <- asin(sqrt(fa_ul[, 11:42]))
