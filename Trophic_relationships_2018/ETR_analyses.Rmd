...
ggplot() +
  ...
  geom_text_repel(aes(x = si.sum$del_C_mean, y = si.sum$del_N_mean, label = si.names), size = 3, vjust = -0.8, hjust = -0.1) +
...
## Primary Producers ##
# Eelgrass #
mod.c.eg.1 <- lm(del_C ~ Sea_otter_tr, data = si_eg)
anova(mod.c.eg.1)

mod.n.eg.1 <- lm(del_N ~ Sea_otter_tr, data = si_eg)
anova(mod.n.eg.1)

# Epiphytes #
mod.c.ep.1 <- lm(del_C ~ Sea_otter_tr, data = si_ep)
anova(mod.c.ep.1)

mod.n.ep.1 <- lm(del_N ~ Sea_otter_tr, data = si_ep)
anova(mod.n.ep.1)

# Fucus #
mod.c.fu.1 <- lm(del_C ~ Sea_otter_tr, data = si_fu)
anova(mod.c.fu.1)

mod.n.fu.1 <- lm(del_N ~ Sea_otter_tr, data = si_fu)
anova(mod.n.fu.1)

# POM #
mod.c.pm.1 <- lm(del_C ~ Sea_otter_tr, data = si_pm)
anova(mod.c.pm.1)

mod.n.pm.1 <- lm(del_N ~ Sea_otter_tr, data = si_pm)
anova(mod.n.pm.1)

# Sugar kelp #
mod.c.sk.1 <- lm(del_C ~ Sea_otter_tr, data = si_sk)
anova(mod.c.sk.1)

mod.n.sk.1 <- lm(del_N ~ Sea_otter_tr, data = si_sk)
anova(mod.n.sk.1)

# Ulva #
mod.c.ul.1 <- lm(del_C ~ Sea_otter_tr, data = si_ul)
anova(mod.c.ul.1)

mod.n.ul.1 <- lm(del_N ~ Sea_otter_tr, data = si_ul)
anova(mod.n.ul.1)

## Primary consumers ##
# Idotea #
mod.c.ido.1 <- lm(del_C ~ Sea_otter_tr, data = si_ido)
anova(mod.c.ido.1)

mod.n.ido.1 <- lm(del_N ~ Sea_otter_tr, data = si_ido)
anova(mod.n.ido.1)

# Butter Clams #
mod.c.but.1 <- lm(del_C ~ Sea_otter_tr, data = si_but)
anova(mod.c.but.1)

mod.n.but.1 <- lm(del_N ~ Sea_otter_tr, data = si_but)
anova(mod.n.but.1)

# Macoma sp. clams #
mod.c.mac.1 <- lm(del_C ~ Sea_otter_tr, data = si_mac)
anova(mod.c.mac.1)

mod.n.mac.1 <- lm(del_N ~ Sea_otter_tr, data = si_mac)
anova(mod.n.mac.1)

## Seconday consumers ##
# Dock Shrimp #
mod.c.dsh.1 <- lm(del_C ~ Sea_otter_tr, data = si_dsh)
anova(mod.c.dsh.1)

mod.n.dsh.1 <- lm(del_N ~ Sea_otter_tr, data = si_dsh)
anova(mod.n.dsh.1)

# Helmet crabs #
mod.c.hel.1 <- lm(del_C ~ Sea_otter_tr, data = si_hel)
anova(mod.c.hel.1)

mod.n.hel.1 <- lm(del_N ~ Sea_otter_tr, data = si_hel)
anova(mod.n.hel.1)

# Graceful crabs #
mod.c.grc.1 <- lm(del_C ~ Sea_otter_tr, data = si_grc)
anova(mod.c.grc.1)

mod.n.grc.1 <- lm(del_N ~ Sea_otter_tr, data = si_grc)
anova(mod.n.grc.1)

# Shiner perch #
mod.c.shn.1 <- lm(del_C ~ Sea_otter_tr, data = si_shn)
anova(mod.c.shn.1)

mod.n.shn.1 <- lm(del_N ~ Sea_otter_tr, data = si_shn)
anova(mod.n.shn.1)

# Snake prickleback #
mod.c.snk.1 <- lm(del_C ~ Sea_otter_tr, data = si_snk)
anova(mod.c.snk.1)

mod.n.snk.1 <- lm(del_N ~ Sea_otter_tr, data = si_snk)
anova(mod.n.snk.1)

# Staghorn sculpin #
mod.c.stg.1 <- lm(del_C ~ Sea_otter_tr, data = si_stg)
anova(mod.c.stg.1)

mod.n.stg.1 <- lm(del_N ~ Sea_otter_tr, data = si_stg)
anova(mod.n.stg.1)
```
