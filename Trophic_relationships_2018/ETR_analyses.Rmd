...
# Crabs - Dungeness #
perm.dun <- adonis2(fa_dun_1.0_dist ~ Sea_otter_tr / Site, data = fa_dun_1.0, perm = 9999)
perm.dun

# Crabs - Helmet #
perm.hel <- adonis2(fa_hel_1.0_dist ~ Sea_otter_tr / Site, data = fa_hel_1.0, perm = 9999)
perm.hel
...
vec.crb.dat$MDS1_sc <- vec.crb.dat$MDS1 * (scalefactor * vec.crb.dat$r2)
vec.crb.dat$MDS2_sc <- vec.crb.dat$MDS2 * (scalefactor * vec.crb.dat$r2)
...
vec.dun.dat$MDS1_sc <- vec.dun.dat$MDS1 * (scalefactor * vec.dun.dat$r2)
vec.dun.dat$MDS2_sc <- vec.dun.dat$MDS2 * (scalefactor * vec.dun.dat$r2)
