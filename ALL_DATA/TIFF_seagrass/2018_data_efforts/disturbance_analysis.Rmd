...
df.elev.means = df.elev.means %>% 
  ...
  mutate(edge_diffuse_elev_corrct_neg = edge_continuous_elev_mllw_cm * (fucus_mean_elev_mllw_cm/169.72)) %>%
...
pz3 = ggplot(df.alldat, aes(edge_continuous_elev_mllw_cm, edge_diffuse_elev_mllw_cm, color = so_region2)) +
...
pz4 = ggplot(df.alldat, aes(so_index_pc2, edge_diffuse_elev_corrct_pos, color = sed1_qual)) +
  geom_point(size=3) + # allows for trendline on general trend
