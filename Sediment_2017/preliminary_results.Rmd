...
# plot organic matter
plot_om_all = ggplot(cr.mat, aes(core_depth, om_w.v)) +
...
plot_im_all = ggplot(cr.mat, aes(core_depth, im_w.v)) +
  stat_summary(fun.y=mean, geom="point")+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.5) +
  coord_flip() +
  scale_x_reverse() +
...
# plot organic matter
plot_om_sites_exL06 = ggplot(cr.mat_noL06, aes(core_depth, om_w.v)) +
  stat_summary(fun.y=mean, geom="point")+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.5) +
  coord_flip() +
  scale_x_reverse() +
...
# plot inorganic matter
plot_im_sites_exL06 = ggplot(cr.mat_noL06, aes(core_depth, im_w.v)) +
  stat_summary(fun.y=mean, geom="point")+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.5) +
  coord_flip() +
  scale_x_reverse() +
...
# plot organic matter
plot_om = ggplot(cr.mat_noL06, aes(core_depth, om_w.v)) +
  stat_summary(fun.y=mean, geom="point")+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.5) +
  coord_flip() +
  scale_x_reverse() +
...
plot_im = ggplot(cr.mat_noL06, aes(core_depth, im_w.v)) +
  stat_summary(fun.y=mean, geom="point")+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.5) +
  coord_flip() +
  scale_x_reverse() +
