...
## Southeast Alaska water polygon
h2o <- readOGR(dsn = "E:/wraymond2/My Documents/Graduate School/GIS General", layer = "SEAK_water_UTM")
```
...
r <- raster(ncol = (848183.9 - 75165.99) / 50, nrow = (6686378 - 6040098) / 50)

# create raster
h2o.rast <- rasterize(h2o, r)

# assign values to raster
h2o.rast@data@values <- 50
```

Create survey area for each site by selecting raster cells within 2nm == 3704 meters from the sites.
```{r survey area}
h2o.trans <- transition(h2o.rast, transitionFunction = mean, directions = 8)
