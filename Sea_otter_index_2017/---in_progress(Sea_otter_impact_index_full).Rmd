...
poparea.utm <- readOGR(dsn = "E:/wraymond2/My Documents/Graduate School/Sea Otter Harvest/GIS Files/Hab_All_1.27.2017", layer = "Hab_All_UTM")
...
## Sea otter impact index
We will be using a principle components analysis to create the sea otter impact index. First its good practice to examine the data a bit.
```{r data exploration}
# Correlations
...
```{r export}
# Data Export
write.csv(final.dat, "../ALL_DATA/sea_otter_impact_index_TEST.csv", row.names = FALSE)
```